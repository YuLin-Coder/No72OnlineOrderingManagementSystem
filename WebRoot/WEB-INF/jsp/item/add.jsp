...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="${ctx}/item/exAdd"  enctype="multipart/form-data">  
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="zk" data-validate="required:请输入菜品折扣" />
          <div class="tips"></div>
        </div>
      </div>
